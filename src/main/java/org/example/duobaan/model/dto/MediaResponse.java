...
public record MediaResponse(
    ...
    public static MediaResponse image(List<MediaItem> items) {
        return new MediaResponse("IMAGE", "succeeded", null, null, null, null, null, items);
    }
    public static MediaResponse video(List<MediaItem> items, String status) {
        return new MediaResponse("VIDEO", status, null, null, null, null, null, items);
    }
    public static MediaResponse asr(String text) {
        return new MediaResponse("AUDIO_ASR", "succeeded", null, text, null, null, null, List.of());
    }
    public static MediaResponse tts(byte[] bytes, String mime, String filename) {
        return new MediaResponse("AUDIO_TTS", "succeeded", null, null, bytes, mime, filename, List.of());
    }
    public static MediaResponse error(String kind, String friendly) {
        return new MediaResponse(kind, "degraded", friendly, null, null, null, null, List.of());
    }
